...
bool ClassMain::onInit()
{
    ...
    this->en->SetPartX(PN::PISTON, start_point.x + 46); this->en->SetPartY(PN::PISTON, start_point.y + 60);
    this->en->SetPartX(PN::CRANK, start_point.x + 60); this->en->SetPartY(PN::CRANK, start_point.y + 180);
    this->en->SetPartX(PN::LINK_ROD, start_point.x + 67); this->en->SetPartY(PN::LINK_ROD, start_point.y + 65);
